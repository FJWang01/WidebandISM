...
function SH_coeff_new = higher_order_source_in_3D_space(r, r_s, elev_s, azim_s, v, u, N, time_vec, c)
% SH_coeff_new = higher_order_source_in_3D_space(r, r_s, elev_s, azim_s, v, u, N, time_vec, c)
%
...
SH_coeff = higher_order_source_on_z_axis(r, r_s, v, u, N, time_vec, c);
